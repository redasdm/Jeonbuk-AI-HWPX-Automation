 ...
 */
export function generateOrgChartMermaid(agents) {
    if (agents.length === 0)
        return null;
    const lines = [];
    lines.push("```mermaid");
 ...
 */
export function generateReadme(manifest, options) {
    const lines = [];
    ...
    if (manifest.skills.length > 0)
        counts.push(["Skills", manifest.skills.length]);
    if (manifest.issues.length > 0)
        counts.push(["Tasks", manifest.issues.length]);
    if (counts.length > 0) {
...
//# sourceMappingURL=company-export-readme.js.map
 ...
 */
export async function prunePluginLogs(db, retentionDays = DEFAULT_RETENTION_DAYS) {
    ...
    if (iterations >= MAX_ITERATIONS) {
        logger.warn({ totalDeleted, iterations, cutoffDate: cutoff }, "Plugin log retention hit iteration limit; some logs may remain");
    }
    if (totalDeleted > 0) {
 ...
 */
export function startPluginLogRetention(db, intervalMs = 60 * 60 * 1_000, retentionDays = DEFAULT_RETENTION_DAYS) {
...
//# sourceMappingURL=plugin-log-retention.js.map
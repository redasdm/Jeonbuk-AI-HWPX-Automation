 ...
 */
export async function notifyHireApproved(db, input) {
    ...
    try {
        ...
        logger.warn({ companyId, agentId, adapterType, source, sourceId, error: result.error, detail: result.detail }, "hire hook: adapter returned failure");
        await logActivity(db, {
            companyId,
            actorType: "system",
            actorId: "hire_hook",
...
//# sourceMappingURL=hire-hook.js.map
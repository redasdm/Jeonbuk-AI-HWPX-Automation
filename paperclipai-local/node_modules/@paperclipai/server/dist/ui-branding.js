...
export function applyUiBranding(html, env = process.env) {
    ...
    return replaceMarkedBlock(withFavicon, RUNTIME_BRANDING_BLOCK_START, RUNTIME_BRANDING_BLOCK_END, renderRuntimeBrandingMeta(branding));
}

...
export const invites = pgTable("invites", {
    ...
    defaultsPayload: jsonb("defaults_payload").$type(),
    ...
    companyInviteStateIdx: index("invites_company_invite_state_idx").on(table.companyId, table.inviteType, table.revokedAt, table.expiresAt),
}));
